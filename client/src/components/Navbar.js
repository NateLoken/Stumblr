...
export default function SimpleBottomNavigation() {
  ...
  return (
    <Box sx={{ width: 500 }}>
      ...
      >
        <BottomNavigationAction label="Map" icon={<RestoreIcon />} />
        <BottomNavigationAction label="Sessions" icon={<FavoriteIcon />} />
        <BottomNavigationAction label="Authentication" icon={<LocationOnIcon />} />
      </BottomNavigation>
    </Box>
  );
}
...
// const pages = ['Map', 'Sessions', 'Authentication'];
...
//                 <Avatar alt="Profile" src="./client/public/user.png"/>
//               </IconButton>
//             </Tooltip>
//             <Menu
//               sx={{ mt: '45px' }}
